...
public class ObjectiveBuilder {
    public static ObjectiveBase fromParams(ObjectiveParamsBase base, ObjectiveType type) {
        switch (type) {
            case KILL_TYPE:
                return new ObjectiveKillType((ParamsKillType) base, type);
            case KILL_SPECIFIC:
                return new ObjectiveKillSpecific((ParamsKillSpecific) base, type);
            case GATHER:
                return new ObjectiveGather((ParamsGather) base, type);
            case TRIGGER:
                return new ObjectiveTrigger((ParamsTrigger) base, type);
            case DELIVER:
                return new ObjectiveDeliver((ParamsDeliver) base, type);
            case ESCORT:
                return new ObjectiveEscort((ParamsEscort) base, type);
            case SEARCH:
                return new ObjectiveSearch((ParamsSearch) base, type);
        }
        return null;
    }
